      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.infoBlock}>
            ...
            <View style={styles.contactSection}>
              ...
              <Text style={styles.contactText}>
                Website: www.tiger-portfolio.com
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.aboutSection}>
          ...
          <Text style={styles.aboutText}>
            ...
            aplicações móveis e web. Tenho facilidade com trabalho em equipe,
            foco em resultados e gosto de aprender coisas novas todos os dias.
          </Text>
        </View>
        {/* Seção: Certificados */}
